...
public static class TypesCommand
{
        ...
        Dictionary<string, List<(string Name, string Type)>> records)
    {
        ...
        sb.AppendLine("import type { CarbonPluginMetadata } from '@dotcarbon/api';");
        sb.AppendLine();
        ...
        sb.AppendLine("}");
        sb.AppendLine();
        sb.AppendLine("export declare const carbonGeneratedPluginMetadata: readonly CarbonPluginMetadata[];");
        sb.AppendLine();
